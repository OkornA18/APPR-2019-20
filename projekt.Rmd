...
```{r graf1, echo=FALSE, fig.align='center', fig.cap='Povprečno število dijakov'}
graf1
```
...
```{r grafs, echo=FALSE, fig.align='center', fig.cap='Povprečno število moških po vrstah izobraževanja v zadnjih desetih letih'}
graf3
```

```{r graf4, echo=FALSE, fig.align='center', fig.cap='Povprečno število žensk po vrstah izobraževanja v zadnjih desetih letih'}
graf4
```
***
